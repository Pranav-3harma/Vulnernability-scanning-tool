# Security Assessment Report: flipkart.in
**Generated Date:** 2026-07-29 14:45:31
...
- Total endpoints discovered: 506
  - `https://1.rome.api.flipkart.com` (Other)  — source: https://flipkart.in
  - `https://2.rome.api.flipkart.com` (Other)  — source: https://flipkart.in
  - `https://static-assets-web.flixcart.com` (Other)  — source: https://flipkart.in
  - `https://rukminim2.flixcart.com` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/logo_lite-cbb357.png` (Other)  — source: https://flipkart.in
  - `image/png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/app-icons/app-icon_192x192.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/app-icons/app-icon_256x256.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/app-icons/app-icon_384x384.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/app-icons/app-icon_512x512.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_430x932.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_393x852.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_390x844.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_428x926.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_375x812.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_414x736.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_320x568.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_414x896.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_375x667.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_1024x1366.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_834x1194.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_820x1180.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_810x1080.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_834x1112.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_768x1024.png` (Other)  — source: https://flipkart.in
  - `/apex-static/images/fk-lite-assets/splash-screen/splash-screen_744x1133.png` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/fonts/Inter-Regular.woff2` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/fonts/Inter-SemiBold.woff2` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/fonts/Inter-Bold.woff2` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/234/image/5b013f4848aeb33a.jpg` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/81c7ef61138b70808f9540bfce756244/MultiWidgetpage.css` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/81c7ef61138b70808f9540bfce756244/CrossCommon.css` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/81c7ef61138b70808f9540bfce756244/CrossPlatformModules.css` (Other)  — source: https://flipkart.in
  - `http://custom.transaction` (Other)  — source: https://flipkart.in
  - `/called` (Other)  — source: https://flipkart.in
  - `API/noticeError/called` (API)  — source: https://flipkart.in
  - `/` (Other)  — source: https://flipkart.in
  - `https://www.flipkart.com` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/81c7ef61138b70808f9540bfce756244/DesktopComponents.css` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/52/44/image/d2ecfddf891a3922.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/26/22/image/d2ecfddf891a3922.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/92/36/image/31f7e3af490c225f.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/46/18/image/31f7e3af490c225f.png` (Other)  — source: https://flipkart.in
  - `/flights-travel-uhp-at-store` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/58/44/image/7ab4040af860941d.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/29/22/image/7ab4040af860941d.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/72/36/image/5a9ff48eef96b876.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/36/18/image/5a9ff48eef96b876.png` (Other)  — source: https://flipkart.in
  - `/search` (Other)  — source: https://flipkart.in
  - `/2000/svg` (Other)  — source: https://flipkart.in
  - `/searchsuggestion` (Other)  — source: https://flipkart.in
  - `/account/login` (Auth)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/profile-6bae67.svg` (Other)  — source: https://flipkart.in
  - `/plus` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/fkplus-f1a046.svg` (Other)  — source: https://flipkart.in
  - `/account/orders` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/orders-e444ac.svg` (Other)  — source: https://flipkart.in
  - `/wishlist` (Other)  — source: https://flipkart.in
  - `/sell-online/` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/Store-134a49.svg` (Other)  — source: https://flipkart.in
  - `/account/rewards` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/rewards-a8acd9.svg` (Other)  — source: https://flipkart.in
  - `/the-gift-card-store` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/GiftCardV2-6885f6.svg` (Other)  — source: https://flipkart.in
  - `/communication-preferences/push` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/notificationPreferences-3439a8.svg` (Other)  — source: https://flipkart.in
  - `/helpcentre` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/helpcenter-f09fd8.svg` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/AdvertiseV2-e6b830.svg` (Other)  — source: https://flipkart.in
  - `/mobile-apps` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/downloadApp-7569a8.svg` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/NotificationSetting-caba6c.svg` (Other)  — source: https://flipkart.in
  - `/viewcart` (Other)  — source: https://flipkart.in
  - `/batman-returns/batman-returns/p/images/header_cart_v4-6ac9a8.svg` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/all.svg` (Other)  — source: https://flipkart.in
  - `/ss-26-base-inline-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/fashion.svg` (Other)  — source: https://flipkart.in
  - `/mobile-phones-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/mobiles.svg` (Other)  — source: https://flipkart.in
  - `/new-elec-clp-march-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/electronics.svg` (Other)  — source: https://flipkart.in
  - `/bpc-bau-new-inline-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/beauty.svg` (Other)  — source: https://flipkart.in
  - `/home-kitchen-25-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/home-final.svg` (Other)  — source: https://flipkart.in
  - `/tv-and-appliances-inline-ab-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/tv.svg` (Other)  — source: https://flipkart.in
  - `/toysbc-new26-inline-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/toy.svg` (Other)  — source: https://flipkart.in
  - `/fnhc-2025-new-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/food.svg` (Other)  — source: https://flipkart.in
  - `/aa-2025-new-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/auto-acc.svg` (Other)  — source: https://flipkart.in
  - `/sf-inline-2025-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/sport.svg` (Other)  — source: https://flipkart.in
  - `/india-ka-furniture-studio-inlines-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/furniture.svg` (Other)  — source: https://flipkart.in
  - `/booksmedia-2025-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/books.svg` (Other)  — source: https://flipkart.in
  - `/twowheelers-at-store` (Other)  — source: https://flipkart.in
  - `/apex-static/images/svgs/L1Nav/auto-new.svg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/360/image/6015c703748e7a42.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/220/image/6015c703748e7a42.jpg` (Other)  — source: https://flipkart.in
  - `/mens-footwear/mens-slippers-flip-flops/pr` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/b68b8e773e9bdfea.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/b68b8e773e9bdfea.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/b68b8e773e9bdfea.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/37bbbecbbc6915ac.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/37bbbecbbc6915ac.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/37bbbecbbc6915ac.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/7e711d684ed9eda8.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/7e711d684ed9eda8.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/7e711d684ed9eda8.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/c6015e16e46589f0.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/c6015e16e46589f0.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/c6015e16e46589f0.png` (Other)  — source: https://flipkart.in
  - `/vivo-t5x-5g-fusion-red-128-gb/p/itm7da8aa253e72b` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/1d9bbad6c2f4f322.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/1d9bbad6c2f4f322.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/1d9bbad6c2f4f322.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/ac5f2b5890cdaec6.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/ac5f2b5890cdaec6.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/ac5f2b5890cdaec6.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/198fd07133a53f34.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/198fd07133a53f34.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/198fd07133a53f34.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/aabb762c8cea7696.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/aabb762c8cea7696.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/aabb762c8cea7696.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/cd02941e1281e0df.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/cd02941e1281e0df.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/cd02941e1281e0df.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/780/image/5e2c4ab813da09b4.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/490/image/5e2c4ab813da09b4.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/230/image/5e2c4ab813da09b4.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/1b28c2b12f494ec0.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/1b28c2b12f494ec0.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image/1b28c2b12f494ec0.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/4843f5e3e39f1a67.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/4843f5e3e39f1a67.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image/4843f5e3e39f1a67.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/ad94a965c7c714de.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/ad94a965c7c714de.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image/ad94a965c7c714de.png` (Other)  — source: https://flipkart.in
  - `/health-care/health-supplements/milk-drink-mixes/pr` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/8cd8932bfdc7b22c.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/8cd8932bfdc7b22c.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image/8cd8932bfdc7b22c.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/b56dbedee1948cb7.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/b56dbedee1948cb7.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image/b56dbedee1948cb7.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/350/170/image/fa6efc428b111226.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/220/110/image/fa6efc428b111226.png` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/110/50/image
  - `/image/140/187/xif0q/shoe/z/c/c/6-atg-424-6-action-grey-watermarked-original-imahfjdcykkpufhg.jpeg` (Other)  — source: https://flipkart.in
  - `/all/~cs-7a04c87a03d025d968662615918edf2d/pr` (Other)  — source: https://flipkart.in
  - `/image/280/374/xif0q/sandal/d/s/7/8-ride-sandal-8-souk-black-white-original-imahphcubgjtpzf7.jpeg` (Other)  — source: https://flipkart.in
  - `/image/140/187/xif0q/sandal/d/s/7/8-ride-sandal-8-souk-black-white-original-imahphcubgjtpzf7.jpeg` (Other)  — source: https://flipkart.in
  - `/all/~cs-c6d1c0bc13f17c317f6447e890166c33/pr` (Other)  — source: https://flipkart.in
  - `/image/280/374/xif0q/sari/1/e/c/free-neelu-orange-snv-25-saanvi-unstitched-original-imahph62zzthquxp.jpeg` (Other)  — source: https://flipkart.in
  - `/image/140/187/xif0q/sari/1/e/c/free-neelu-orange-snv-25-saanvi-unstitched-original-imahph62zzthquxp.jpeg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1570/350/image/679f84c79e14f710.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/980/220/image/679f84c79e14f710.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/470/100/image/679f84c79e14f710.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1600/640/image/70fcb68e3d18caa4.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/1000/400/image/70fcb68e3d18caa4.jpg` (Other)  — source: https://flipkart.in
  - `/fk-p-flap/480/190/image/70fcb68e3d18caa4.jpg` (Other)  — source: https://flipkart.in
  - `/product/p/itme` (Other)  — source: https://flipkart.in
...
|---|---|---|---|---|
| **LOW** | Google Captcha Key | `https://flipkart.in/` | `6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGcgZml` | medium |
| **LOW** | Google Captcha Key | `https://flipkart.in/` | `6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHBhdGg` | medium |
| **LOW** | Google Captcha Key | `https://flipkart.in/` | `6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGcgY2x` | medium |
| **HIGH** | API Token / Key | `https://flipkart.in/` | `api_from_browser_ab` | medium |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `acerpure-nitro-189-2-cm-75-inch-ql` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `ach-set-of-3-silver-original-imaha` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `acid-oily-skin-sulphate-free-anti-` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `ace-cleanser-lha-zinc-acne-pimples` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `ace-serum-skin-brightening-2-niaci` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `ack-stunners-6-0-white-dial-silver` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `acid-face-serum-1-alpha-arbutin-ni` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `acinamide-dark-spots-blemishes-pig` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `aCBkPSJNMTMuNTQzNiAxMC42MTc5TDIwLj` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `ACE_HEADER_V3_DLS_1_tabbedHeaderWi` | high |
| **HIGH** | Twilio Account SID | `https://flipkart.in/` | `across-funnel-renaming-ads-to-spon` | high |
| **MEDIUM** | Twilio App SID | `https://flipkart.in/` | `ap-adore-baby-carrier-3-carry-posi` | medium |
| **MEDIUM** | Twilio App SID | `https://flipkart.in/` | `apple-iphone-16-pro-natural-titani` | medium |
| **MEDIUM** | Twilio App SID | `https://flipkart.in/` | `apple-iphone-17-pro-cosmic-orange-` | medium |
| **MEDIUM** | Twilio App SID | `https://flipkart.in/` | `Appliances_ATLAS_OMU_V3_OMU_WITH_T` | medium |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` | `8620794b-87fa-4e66-9eff-534828a75346` | high |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` | `0761f406-0baa-4fad-94e9-7fb1b27e8ca7` | high |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` | `f39a2445-7004-4a5a-a695-834fe1f5a1e8` | high |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` | `046495cc-c0f7-46dd-99ef-a63f8833e4c8` | high |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` | `f7634981-4fd5-4127-9b93-9f57606dccd3` | high |
| **CRITICAL** | Heroku API Key | `https://flipkart.in/` |